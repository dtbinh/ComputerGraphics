...
public:
	...
	bool triangleIntersectTest(Ray ray, MeshTriangle meshTriangle, real_t t0, real_t t1, HitRecord *hitRecord, Vector2& texCoord) const;

	Vector3 getMax(MeshTriangle meshTriangle) const;
	Vector3 getMin(MeshTriangle meshTriangle) const; 
